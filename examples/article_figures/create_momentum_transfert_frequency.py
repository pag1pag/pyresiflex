...
ax_E.plot(E_N_3000K, nu_N_m_3000K, label="3000 K")
ax_E.plot(E_N_2000K, nu_N_m_2000K, label="2000 K")
...
nu_N_m_interpolated_3000K = np.interp(
    reduced_electric_field_Td, E_N_3000K, nu_N_m_3000K, left=0, right=0
)
nu_N_m_interpolated_2000K = np.interp(
    reduced_electric_field_Td, E_N_2000K, nu_N_m_2000K, left=0, right=0
)
...
T = 3000  # [K]
n_gas = P / (k_b * T)  # [m^-3]
nu_m_3000K = nu_N_m_interpolated_3000K * n_gas  # [s^-1]
T = 2000  # [K]
n_gas = P / (k_b * T)  # [m^-3]
nu_m_2000K = nu_N_m_interpolated_2000K * n_gas  # [s^-1]
...
np.savetxt(
    ...
    np.column_stack((times_plasma, nu_m_3000K, nu_m_2000K)),
    delimiter=",",
    header="time [s], "
    "momentum transfer frequency [Hz] at 3000 K, "
    "momentum transfer frequency [Hz] at 2000 K",
)
