...
if __name__ == "__main__":
    # Run the reconstruction directly (outside pytest) and show the plots.
    # `setup_experiment.__wrapped__` is the underlying fixture function, which
    # can be called directly to build the setup dictionary.
    test_reconstruct_resistance_from_signals(
        setup_experiment.__wrapped__(),  # type: ignore
        plot=True,
    )
